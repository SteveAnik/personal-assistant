...
echo ""
echo "  Chat UI (Open WebUI):  http://localhost:3100"
echo "  n8n Automation:        http://localhost:5679"
echo "  Agent Core API:        http://localhost:8100"
echo "  Agent Core Docs:       http://localhost:8100/docs"
echo ""
echo "Next steps:"
echo "  1. Open n8n at http://localhost:5679 and connect your Gmail OAuth2 credentials"
...
echo "  5. Open http://localhost:3100 and start chatting!"
echo ""
